  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="NextJS Movie App with Tailwind" key="title" />
        <meta property="og:description" content="NextJS Movie App with Tailwind deployed on Vercel" />
